...
{/* <div class="-mx-4 flex flex-wrap">
   <div class="w-full px-4 md:w-1/2 lg:w-1/3">
      <div class="mb-12">
         ...
         <input type="text" placeholder="Default Input" class="w-full bg-transparent rounded-md border border-stroke dark:border-dark-3 py-[10px] px-5 text-dark-6 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 disabled:border-gray-2" />
      </div>
   </div>
   <div class="w-full px-4 md:w-1/2 lg:w-1/3">
      <div class="mb-12">
         ...
         <input type="text" placeholder="Active Input" class="w-full bg-transparent rounded-md border border-primary py-[10px] px-5 text-dark-5 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 disabled:border-gray-2" />
      </div>
   </div>
   <div class="w-full px-4 md:w-1/2 lg:w-1/3">
      <div class="mb-12">
         ...
         <input type="text" placeholder="Disabled Input" disabled class="w-full rounded-md border border-stroke dark:border-dark-3 py-[10px] px-5 text-dark-6 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 disabled:border-gray-2" />
      </div>
   </div>
   <div class="w-full px-4 md:w-1/2 lg:w-1/3">
      <div class="mb-12">
         ...
         <div class="relative">
            <input type="text" placeholder="Devid Jhon" class="w-full bg-transparent rounded-md border border-stroke dark:border-dark-3 py-[10px] pr-3 pl-12 text-dark-6 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2" />
   ...
   <div class="w-full px-4 md:w-1/2 lg:w-1/3">
      <div class="mb-12">
         ...
         <div class="relative">
            <input type="email" placeholder="info@yourmai.com" class="w-full bg-transparent rounded-md border border-stroke dark:border-dark-3 py-[10px] pr-3 pl-12 text-dark-6 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2" />
            <span class="absolute top-1/2 left-4 -translate-y-1/2">
               <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g opacity="0.8">
                     <path fill-rule="evenodd" clip-rule="evenodd" d="M3.33398 4.16667C2.87756 4.16667 2.50065 4.54357 2.50065 5V15C2.50065 15.4564 2.87756 15.8333 3.33398 15.8333H16.6673C17.1238 15.8333 17.5007 15.4564 17.5007 15V5C17.5007 4.54357 17.1238 4.16667 16.6673 4.16667H3.33398ZM0.833984 5C0.833984 3.6231 1.95708 2.5 3.33398 2.5H16.6673C18.0442 2.5 19.1673 3.6231 19.1673 5V15C19.1673 16.3769 18.0442 17.5 16.6673 17.5H3.33398C1.95708 17.5 0.833984 16.3769 0.833984 15V5Z" fill="#9CA3AF" />
                     <path fill-rule="evenodd" clip-rule="evenodd" d="M0.984696 4.52154C1.24862 4.14449 1.76823 4.0528 2.14527 4.31673L10.0007 9.81554L17.8562 4.31673C18.2332 4.0528 18.7528 4.14449 19.0167 4.52154C19.2807 4.89858 19.189 5.41818 18.8119 5.68211L10.4786 11.5154C10.1917 11.7163 9.80977 11.7163 9.52284 11.5154L1.1895 5.68211C0.812463 5.41818 0.720767 4.89858 0.984696 4.52154Z" fill="#9CA3AF" />
                  </g>
               </svg>
            </span>
         </div>
   ...
   <div class="w-full px-4 md:w-1/2 lg:w-1/3">
      <div class="mb-12">
         ...
         <div class="flex items-center">
            <span class="h-full rounded-tl-md rounded-bl-md border border-r-0 border-stroke dark:border-dark-3 bg-gray-2 dark:bg-dark-2 py-[10px] px-4 text-base uppercase text-body-color dark:text-dark-6">
            USD
            </span>
            <input type="text" placeholder="Pimjo Labs" class="w-full bg-transparent rounded-br-md rounded-tr-md border border-stroke dark:border-dark-3 py-[10px] pr-3 pl-5 text-dark-6 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2" />
         </div>
      </div>
   </div>
   <div class="w-full px-4 md:w-1/2 lg:w-1/3">
      <div class="mb-12">
         ...
         <div class="relative">
            <input type="email" placeholder="Devid Jhon" class="w-full bg-transparent rounded-md border border-red py-[10px] pl-5 pr-12 text-dark-6 outline-none transition" />
         ...
         <p class="mt-[10px] text-sm text-red">Invalid email address</p>
      </div>
   </div>
   <div class="w-full px-4 md:w-1/2 lg:w-1/3">
      <div class="mb-12">
         ...
         <div class="relative">
            <input type="email" placeholder="Devid Jhon" class="w-full bg-transparent rounded-md border border-green py-[10px] px-12 text-dark-6 outline-none transition" />
            <span class="absolute top-1/2 left-4 -translate-y-1/2">
               <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g opacity="0.8">
         ...
         <p class="mt-[10px] text-sm text-green">Password is strong</p>
      </div>
   </div>
</div>
...
<div class="flex flex-col rounded-2xl w-[600px] bg-[#ffffff] shadow-xl">
  ...
  <div class="">
 <h3 class="mt-10 font-bold text-lg text-[#374151] mb-2">Add a New Friend:</h3>

  <div class="field">
    <%= form.label :name %>
    <%= form.text_field :name, id: :friend_name, class: "px-4 py-2 mb-2 text-md  rounded-md border focus:outline focus:outline-2 focus:outline-offset-2 bg-[#defffd] text-[#444444] focus:outline-[#aaaaaa] border-[#cccccc]"%>
  </div>

  <div class="field">
    <%= form.label :birthday %>
    <%= form.date_field :birthday, id: :friend_birthday, class: "px-4 py-2 mb-2 text-md  rounded-md border focus:outline focus:outline-2 focus:outline-offset-2 bg-[#defffd] text-[#444444] focus:outline-[#aaaaaa] border-[#cccccc]" %>
  </div>

  <h3 class="mt-10 font-bold text-lg text-[#374151] mb-2">Gift Ideas:</h3>
  <div id="gifts">
    <%= form.fields_for :gifts do |gift_form| %>
      <div class="nested-fields">
        <div class="field">
          <%= gift_form.label :name %>
          <%= gift_form.text_field :name, class: "px-4 py-2 mb-2 text-md  rounded-md border focus:outline focus:outline-2 focus:outline-offset-2 bg-[#defffd] text-[#444444] focus:outline-[#aaaaaa] border-[#cccccc]" %>
        </div>

        <div class="field">
          <%= gift_form.label :price %>
          <%= gift_form.number_field :price, class: "px-4 py-2 mb-2 text-md  rounded-md border focus:outline focus:outline-2 focus:outline-offset-2 bg-[#defffd] text-[#444444] focus:outline-[#aaaaaa] border-[#cccccc]" %>
        </div>

        <div class="field">
          <%= gift_form.label :link %>
          <%= gift_form.text_field :link, class: "px-4 py-2 mb-2 text-md  rounded-md border focus:outline focus:outline-2 focus:outline-offset-2 bg-[#defffd] text-[#444444] focus:outline-[#aaaaaa] border-[#cccccc]" %>
        </div>

        <%= link_to 'Remove this gift', '#', class: 'remove-gift' %>
      </div>
    <% end %>
  </div>
  <%= link_to 'Add Gift', '#', id: 'add-gift-link', class: 'btn btn-primary' %>
...
<template id="gift-fields-template">
  <div class="nested-fields">
    <div class="field">
      <%= label_tag 'friend[gifts_attributes][NEW_RECORD][name]', 'Gift name' %>
      <%= text_field_tag 'friend[gifts_attributes][NEW_RECORD][name]', '', class: 'px-4 py-2 mb-2 text-md  rounded-md border focus:outline focus:outline-2 focus:outline-offset-2 bg-[#defffd] text-[#444444] focus:outline-[#aaaaaa] border-[#cccccc] form-control' %>
    </div>

    <div class="field">
      <%= label_tag 'friend[gifts_attributes][NEW_RECORD][price]', 'Price' %>
      <%= text_field_tag 'friend[gifts_attributes][NEW_RECORD][price]', '',class: 'px-4 py-2 mb-2 text-md  rounded-md border focus:outline focus:outline-2 focus:outline-offset-2 bg-[#defffd] text-[#444444] focus:outline-[#aaaaaa] border-[#cccccc] form-control'%>
    </div>

    <div class="field">
      <%= label_tag 'friend[gifts_attributes][NEW_RECORD][link]', 'Link' %>
      <%= text_field_tag 'friend[gifts_attributes][NEW_RECORD][link]', '', class:'px-4 py-2 mb-2 text-md  rounded-md border focus:outline focus:outline-2 focus:outline-offset-2 bg-[#defffd] text-[#444444] focus:outline-[#aaaaaa] border-[#cccccc] form-control' %>
    </div>
